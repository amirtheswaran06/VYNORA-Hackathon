          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 animate-fadeIn max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleApply} className="mt-4 space-y-4 text-xs">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Monthly Installment (EMI)</span>
                ...
                <span className="text-[#138808] font-black uppercase text-[10px] tracking-wider bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-200">
                  Auto-Debit FASTag/UPI
                </span>
              </div>

              <div>
                <label className="font-black uppercase tracking-wider text-slate-700 block mb-1">Commercial Driver Name:</label>
                <input
                  type="text"
                  required
                  value={applicantName}
                  onChange={(e) => setApplicantName(e.target.value)}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 outline-none font-medium focus:ring-2 focus:ring-[#0B1F3A]"
                />
              </div>

              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  <label className="font-black uppercase tracking-wider text-slate-700 block mb-1">Mobile Phone:</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="font-black uppercase tracking-wider text-slate-700 block mb-1">Vehicle Registration:</label>
                  <input
                    type="text"
                    required
                    value={vehicleNumber}
                    onChange={(e) => setVehicleNumber(e.target.value)}
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 font-mono uppercase font-black"
                  />
                </div>
              </div>

              <div>
                <label className="font-black uppercase tracking-wider text-slate-700 block mb-1">Purpose of Credit Assistance:</label>
                <input
                  type="text"
                  required
                  value={loanPurpose}
              ...
              <div className="mt-6 flex gap-3 pt-3 border-t border-slate-100">
                ...
                >
                  ...
                  Submit Application (Instant Disbursal)
                </button>
              </div>
            </form>
          </div>
